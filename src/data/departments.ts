...
export const departments: DepartmentDetails[] = [
  ...
  },
  {
    ...
    teachingStaff: ["Ms Carren Shiunda","Ms Dorcas Aswani","Ms Mirriam Wasike","Ms Brazeal Namalwa","Ms Anne Nabwire"],
    nonTeachingStaff: [],
    trainers: ["Ms Carren Shiunda","Ms Dorcas Aswani","Ms Mirriam Wasike","Ms Brazeal Namalwa","Ms Anne Nabwire"],
    objectives: [
