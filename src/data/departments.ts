...
export const departments: DepartmentDetails[] = [
  ...
  },
  {
    ...
    hodImage: "/images/hod/DOROTHY_LUDISI_LIYAYI.png",
  ...
  },
  {
    ...
    hodImage: "/images/hod/EVANS_MUMBWAMI_MARUTI.png",
  ...
  },
  {
    ...
    nonTeachingStaff: ["Mark Wanami-Welder"],
  ...
  },
  {
    ...
    hodImage: "/images/hod/carrensheunda.png",
    hodName: "Carren Sheunda",
    ...
    teachingStaff: ["Ms Tabitha Indiori","Ms Dorcas Aswani","Ms Mirriam Wasike","Ms Brazeal Namalwa","Ms Anne Nabwire"],
    nonTeachingStaff: [],
    trainers: ["Ms Tabitha Indiori","Ms Dorcas Aswani","Ms Mirriam Wasike","Ms Brazeal Namalwa","Ms Anne Nabwire"],
    objectives: [
  ...
  },
  {
    ...
    teachingStaff: ["Ms Isabel Gimode","Ms Elizabeth Sikoyo","Ms Brenda Asiyo"],
    nonTeachingStaff: [],
    trainers: ["Ms Isabel Gimode","Ms Elizabeth Sikoyo","Ms Brenda Asiyo"],
    objectives: [
