...
export default function ArtisanCoursesPage() {
  ...
  const {
    ...
    queryKey: ["/api/courses", { type: "artisan" }],
  ...
  const filteredCourses = useMemo((): Course[] => {
    ...
    if (searchTerm) {
      return artisanCourses.filter((course: Course) =>
  ...
  const getIconColor = (index: number): string => {
    const colors = ["bg-orange-500", "bg-red-500", "bg-purple-500", "bg-indigo-500", "bg-blue-500", "bg-green-500"];
    ...
    return (
      <div className="min-h-screen bg-gray-50 py-16">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-3xl font-bold text-red-600 mb-4">Error Loading Artisan Courses</h1>
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-6">
            Our artisan programs provide hands-on, practical training for skilled trades. These Level 3-4 programs typically run for 3-8 months and are designed to get you job-ready quickly with essential technical skills.
          </p>
          <div className="flex items-center justify-center gap-6 text-sm text-gray-600">
            <div className="flex items-center gap-2">
              <Clock className="w-4 h-4" />
              <span>3-8 Months Duration</span>
            </div>
            <div className="flex items-center gap-2">
              <Star className="w-4 h-4" />
              <span>Level 3-4 Qualification</span>
            </div>
            <div className="flex items-center gap-2">
        ...
        {filteredCourses.length > 0 ? (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredCourses.map((course: Course, index: number) => {
              ...
              return (
                <Card key={course.id} className="p-6 hover:shadow-xl transition-all duration-300 hover:scale-105 border-l-4 border-l-orange-500">
                  <div className="flex items-start space-x-4">
        ...
        {/* Call to Action */}
        <div className="text-center mt-16 bg-orange-50 rounded-lg p-8">
