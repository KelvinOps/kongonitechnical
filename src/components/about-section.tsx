        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              <button className="w-full bg-green-600 hover:bg-green-700 text-white font-semibold py-4 px-6 rounded-xl transition-colors duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1">
                Apply Now
              </button>
              
              <div className="grid grid-cols-2 gap-3">
                <button className="border-2 border-blue-600 text-blue-600 font-semibold py-2 px-4 rounded-lg hover:bg-blue-600 hover:text-white transition-colors duration-300 text-sm">
                  Visit Campus
                </button>
                <button className="border-2 border-green-600 text-green-600 font-semibold py-2 px-4 rounded-lg hover:bg-green-600 hover:text-white transition-colors duration-300 text-sm">
                  Download Brochure
                </button>
              </div>
            </div>
            ...
            <div className="relative bg-white rounded-2xl shadow-2xl overflow-hidden transform hover:scale-105 transition-transform duration-300">
              ...
              <div className="relative p-6">
                <div className="flex items-center mb-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900">Watch Our Story</h3>
                    <p className="text-sm text-gray-600">Shaping Minds Since 2019</p>
                  </div>
                </div>
