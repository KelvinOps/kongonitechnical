...
"[project]/src/app/courses/certificate/page.tsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function CertificateCoursesPage() {
    ...
    const { data: certificateCourses, isLoading, error } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useQuery"])({
        queryKey: [
            "/api/courses",
            {
                type: "certificate"
    ...
    const filteredCourses = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>{
        ...
        if (searchTerm) {
            return certificateCourses.filter((course)=>course.title.toLowerCase().includes(searchTerm.toLowerCase()) || course.description.toLowerCase().includes(searchTerm.toLowerCase()));
        }
    ...
    const getIcon = (title)=>{
        ...
        if (titleLower.includes("fashion")) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$scissors$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__Scissors$3e$__["Scissors"];
...
//# sourceMappingURL=_7e590672._.js.map